...
export default async function Home() {
  ...
  const renderForecastCard = (forecast: ForecastData) => (
    <Card className='w-[50%] md:w-[20%] mb-5 md:mb-0 text-sm md:text-base hover:scale-125 transition duration-500 cursor-pointer' key={forecast.dt} style={{ opacity: 0, transition: 'opacity 1s ease-in-out' }}>
